...
export function PlaceInfoCard({ listing, highlighted = false }: PlaceInfoCardProps) {
  const dateLabel = `${listing.dateStart} - ${listing.dateEnd}`;
